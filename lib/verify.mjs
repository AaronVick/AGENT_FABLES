...
export function verifyInstallation(root) {
  const required = ['index.json', 'index.jsonl', 'memory.jsonl', 'incidents.json', 'trust.json', 'capabilities.json', 'steward.json', 'contact-policy.json', 'leaders.json', 'freshness.json', 'guardrail-contract.json', 'contribution-contract.json', 'adoption-kit.json', 'schemas/guardrail-finding.schema.json', 'schemas/evidence-candidate.schema.json']
