...
export function verifyInstallation(root) {
  const required = ['index.json', 'index.jsonl', 'memory.jsonl', 'incidents.json', 'trust.json', 'capabilities.json', 'steward.json', 'contact-policy.json', 'leaders.json', 'freshness.json', 'guardrail-contract.json', 'contribution-contract.json', 'adoption-kit.json', 'publication-state.json', 'START_HERE.md', 'SANDBOX.md', 'agent-entry.json', 'sandbox/agent-fables-sandbox.mjs', 'schemas/guardrail-finding.schema.json', 'schemas/evidence-candidate.schema.json']
